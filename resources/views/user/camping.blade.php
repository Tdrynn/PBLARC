    ...
    <div class="row">
        <div id="picnic" class="text-light learnMore py-4">
            <div class="container-fluid px-0 my-1 mt-2 mb-4">
                <h1 class="text-center fw-bold">Camping</h1>
                    ...
                    <div class="col-md-6 ps-1">
                        <div class="d-flex flex-wrap gap-1">
                            <img src="{{ Vite::asset('resources/images/CP2.png') }}" alt="camping"
                                class="rounded-4 object-fit-cover" width="300px" height="195px">
            ...
            <div class="mt-5">
                ...
                <div class="container text-dark rounded-4" style="background-color:#fff; width:90%; padding:8px 0;">
                    ...
                    <div class="row mb-2">
                        <div class="col ms-3 border-end border-3" style="border-color:#ccc;">
                        ...
                        <div class="col d-flex justify-content-end align-items-end">
                            <button class="btn text-light fw-semibold rounded-4 me-3 mb-3" style="background-color:#114A06; width:90px; height:40px;">Booking</button>
                        </div>
                    </div>
                </div>
            </div>
