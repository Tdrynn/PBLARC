                            ...
                            @foreach ($images as $index => $image)
                                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                    <img src="{{ asset('storage/' . $image->image) }}" class="d-block w-100 main-img"
                                        alt="{{ $image->title ?? 'Camper Van Image' }}">
                                </div>
                            @endforeach
            ...
            <div class="my-3 bg-white rounded-4 shadow-sm p-2 mx-auto" style="width: 90%;">
                <div class="my-2">
                    ...
                    <div class="container" style="width: 95%;">
                        <div class="row">
                            <div class="col-md-6 col-12 d-flex justify-content-start gap-3" style="width: 50%">
                                <div>
                                ...
                                <div>
                                    <h6 class="fw-semibold fs-5">Add More Person
                                        <p class="my-0 fs-6 fw-normal">+ IDR 25k / Day</p>
                                    </h6>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mx-auto col-12 align-item-center">
                                ...
                                <form action="{{ route('bookingCampervan') }}" method="GET">
